...
const ModalPasswordField: React.FunctionComponent<ModalPasswordFieldProps> = ({open, onClose, endpoint, validationFunction, passwordEndpoint}) => {
    const style = {
        ...
        return (
            <Box sx={FieldStyle}>
                <Typography sx={{marginRight: 2, fontSize: 20}}>
                    {fieldName}{' '}
                    <Typography component={'span'} sx={{display: 'inline', fontSize: 20, color: '#ADD8E6'}}>
                        {displayValue}
                    </Typography>
                </Typography>
        ...
        return (
            <Box sx={FieldStyle}>
                ...
                <ModalField
                    ...
                    displayedValueFunction={displayedValueFunction}
                    endpoint={endpoint}
                    validationFunction={validationFunction}
                />
            </Box>
            ...
            <div>
                <Box sx={AccountManagementStyle}>
                    <Field
                        ...
                        fieldName="Username"
                        endpoint={[alterUsername, {originalUsername: username}]}
                        displayValue={username}
                        displayedValueFunction={(val: string) => {
                            setUserName(val)
                        }}
                    ...
                    <Field
                        ...
                        endpoint={[alterUserFirstName, {username: username}]}
                    ...
                    <Field
                        fieldName="Last Name"
                        endpoint={[alterUserLastName, {username: username}]}
                    ...
                    <Field
                        ...
                        fieldName="Email"
                        endpoint={[alterUserEmail, {username: username}]}
                        displayValue={email}
                        displayedValueFunction={(val: string) => {
                            setEmail(val)
                        }}
                    ...
                    <Field
                        ...
                        passwordEndpoint={[isCorrectPassword, {username: username}]}
                        endpoint={[alterPassword, {username: username}]}
                        validationFunction={validatePassword}
                    />
                </Box>
                <Box sx={{textAlign: 'right', marginRight: 5}}>
                    <Button
                        sx={{background: 'white', '&:hover': {background: 'grey', color: 'white'}}}
                        onClick={() => {
